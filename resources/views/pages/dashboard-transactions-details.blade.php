...
@section('title')
    Dashboard Transactions Details | BWASTORE
@endsection
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12 col-md-8">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">${{ number_format($transactions->transaction->total_price)}}</div>
                        </div>
                        <div class="col-12 col-md-6">
                  ...
                  <form action="{{ route('dashboard-transactions-update', $transactions->id)}}" method="POST" enctype="multipart/from-data">
                  @csrf
                      ...
                      <div class="col-12">
                        <div class="row">
                          <div class="col-12 col-md-6">
                            ...
                            <div class="product-subtitle">
                              {{ $transactions->transaction->user->addres_one}}
                            </div>
                          </div>
                          <div class="col-12 col-md-6">
                            <div class="product-title">Address II</div>
                            <div class="product-subtitle">
                              {{ $transactions->transaction->user->addres_two}}
                            </div>
                          </div>
                          <div class="col-12 col-md-6">

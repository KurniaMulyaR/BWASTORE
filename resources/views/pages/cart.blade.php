    ...
    <div class="page-content page-details">
      ...
      <section class="store-cart">
          <div class="container">
              ...
              <form action="{{ route('checkout')}}" id="locations" enctype="multipart/from-data" method="POST">
              @csrf
              <input type="hidden" name="total_price" value="{{ $totalPrice}}"> 
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address_two" name="address_two" value="Setra Duta Cemara">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="zip_code" name="zip_code" value="40151">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-8 col-md-3">
                        <button type="submit" class="btn btn-add mt-4 px-4 btn-block">
                        Checkout Now</button>
                    </div>
                </div>
              </form>
